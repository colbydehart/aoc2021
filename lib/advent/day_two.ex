defmodule Advent.DayTwo do
  ...
  defp handle_instruction(["forward", amount], {x, y}), do: {x + amount, y}
  defp handle_instruction(["down", amount], {x, y}), do: {x, y + amount}
  defp handle_instruction(["up", amount], {x, y}), do: {x, y - amount}
