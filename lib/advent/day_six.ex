defmodule Advent.DaySix do
  ...
  iex> Advent.DaySix.part_one([3,4,3,1,2], 18)
  26

  iex> Advent.DaySix.part_one([3,4,3,1,2], 80)
  5934
  """
  def part_one([], _), do: 0
  def part_one([fish | fishes], days) do
    pass_days(fish, days, 1) + part_one(fishes, days)
  end


  def pass_days(_, 0, total), do: total
  def pass_days(0, days, total), do: 
    pass_days(6, days - 1, total) + pass_days(8, days - 1, total)
  def pass_days(x, days, total), do: pass_days(x - 1, days - 1, total)
end
